...
public class Team extends EspnEntity<Team> {
    ...
    public int getCurrentProjectedRank() {
        return currentProjectedRank;
    }
    public void setCurrentProjectedRank(int currentProjectedRank) {
        this.currentProjectedRank = currentProjectedRank;
    }

    public int getDraftDayProjectedRank() {
        return draftDayProjectedRank;
    }
    ...
    public Optional<DraftStrategy> getDraftStrategy() {
        return Optional.ofNullable(draftStrategy);
    }
    ...
    public int getRegularSeasonPoints() {
        return regularSeasonPoints;
    }
    ...
    public int getCurrentWaiverWireRank() {
        return currentWaiverWireRank;
    }
